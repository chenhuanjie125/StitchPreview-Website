...
require_text "$support" 'Stitch previews'
require_text "$support" 'Embedded-image preview'
require_text "$support" 'Not yet supported'
...
require_text "$translations" '格式支持与帮助。'
